...
<ul>
    ...
    <li>
        <asp:TextBox Width="200" runat="server" ID="tbxTitle" Property="SurveyModel.Title" />
    </li>
</ul>
<ul>
    <li>
...
<ul>
    ...
    <li>
        <dx:ASPxSpinEdit Width="200" runat="server" ID="seOrderIndex" Property="SurveyModel.OrderIndex"></dx:ASPxSpinEdit>
    </li>
</ul>
<ul>
    <li>
