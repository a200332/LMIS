...
{
    public partial class UserReports : BasePage
    {
        ...
        private void CheckDataLanguage()
        {
            ...
            var entity = DataContext.LP_UserReports.FirstOrDefault(n => n.ID == itemID);
            if (entity == null)
                return;
            ...
            if (!StringComparer.OrdinalIgnoreCase.Equals(entity.Language, currentLanguage))
            {
                ...
                var langSpecEntity = (from n in DataContext.LP_UserReports
