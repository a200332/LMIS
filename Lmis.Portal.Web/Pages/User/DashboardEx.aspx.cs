...
namespace Lmis.Portal.Web.Pages.User
{
    public partial class DashboardEx : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var url = new UrlHelper("~/Pages/User/ReportsConfigEx.aspx");
            url["TargetUrl"] = LmisCommonUtil.ConvertToBase64("~/Pages/User/DashboardEx.aspx");
        ...
        private void FillReports()
        {
            ...
            if (categoryID == null)
            {
                ...
                var url = String.Format("~/Pages/User/DashboardEx.aspx?CategoryID={0}", langSpecCategory.ID);
