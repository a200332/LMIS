																...
																<div class="popup">
																	<div style="float: left;">
																		...
																		<div class="box_body_popup">
																			...
																			<div class="box_popup">
																				<mis:DropDownList ID="cmbAttributeSchemas" CssClass="content_left_dropdown" DataTextField="Name"
																					DataValueField="ID" Width="180px" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmbAttributeSchemas_SelectedIndexChanged" />
																			</div>
																		</div>
																		<div class="box_body_popup">
																			<div class="box_title_popup" style="color: #5D5D5D; font-size: 12px; width: 150px;">
																			...
																			<div class="box_popup">
																				<mis:DropDownList ID="cmbAttributeSchemaNodes" CssClass="content_left_dropdown" DataTextField="Name"
																					DataValueField="ID" Width="180px" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmbAttributeSchemaNodes_SelectedIndexChanged" />
																			</div>
																		</div>
																		<div class="box_body_popup">
																			<div class="box_title_popup" style="color: #5D5D5D; font-size: 12px; width: 150px;">
															...
															<div class="popup">
																<div style="float: left;">
																	...
																	<div class="box_body_popup" style="float: left;">
																		...
																		<div class="box_popup">
																			<mis:DropDownList ID="cmbShowAttributeSchemas" CssClass="content_left_dropdown" TextField="Name"
															...
															<div class="popup">
																<div style="float: left;">
																	...
																	<div class="box_body_popup" style="width: 490px;">
																		...
																		<div class="box_popup">
																			<mis:DropDownList ID="ddlAccessLevels" Width="320" runat="server">
																				<Items>
